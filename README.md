...
* **Release tooling**：`scripts/check-release-gate.js` 和 `scripts/generate-release-sbom.js` 检查必备 release 文件、workspace Apache-2.0 元数据、ignored runtime/model/user-data 路径、tracked secret 模式、模型 manifest 许可证元数据、workspace package dry-run 内容和 SPDX 2.3 SBOM 生成。
