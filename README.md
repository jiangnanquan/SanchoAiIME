...
- [x] **Phase 1–2** — 极简 Rime shell、快速字典与 Dashboard UI
- [x] **Phase 3** — 本地预测模型（Lua → HTTP → 候选重排 + 神经 runner 异步缓存）
- [x] **Phase 4** — DeepSeek 教师层（离线分析）
- [x] **Phase 5** — 外部词库导入
- [x] **Phase 6** — 发布合规（许可证、NOTICE、SBOM）
- [ ] **Phase 7** — 本地小模型下一词预测 benchmark、默认 runner 体验优化
- [ ] **Phase 8** — Apple Developer ID 签名与公证
- [ ] **Phase 9** — 自研输入法壳（见 [docs/native-ime-vision.md](docs/native-ime-vision.md)）
